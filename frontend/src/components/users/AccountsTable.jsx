...
import { accountsColumns } from "@/components/users/Columns";
import TableSkeleton from "@/components/skeleton/TableSkeleton";
import { Label } from "../ui/label";

const AccountsTable = ({ data, loading, onClick, onAdd, onEdit }) => {
  ...
  const filterColumns = ["username", "role", "email"];

  const table = useReactTable({
    data,
    columns: accountsColumns(onEdit),
