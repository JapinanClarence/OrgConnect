...
const AnnouncementPage = () => {
  ...
  return (
    <>
      <div className="bg-[#fefefe] md:h-[86vh] md:shadow-lg md:rounded-lg border border-gray-200 text-gray-900 px-6 md:px-5 pb-5 flex flex-col gap-5 md:gap-8 relative">
